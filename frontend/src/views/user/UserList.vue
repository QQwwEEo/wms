<template>
  <div class="wms-card">
    ...
    <div class="page-header">
      ...
      <el-button type="primary" @click="openAdd" id="btn-add-user">
    ...
    <div class="search-bar">
      ...
      <el-select v-model="searchForm.role" placeholder="选择角色" clearable style="width:160px">
        <el-option label="普通用户" value="user" />
        <el-option label="仓管员" value="manager" />
    ...
    <el-table :data="tableData" v-loading="loading" stripe border style="width:100%">
      ...
      <el-table-column prop="role" label="角色" width="110">
        <template #default="{ row }">
          ...
          <el-tag v-else-if="row.role === 'manager'" type="warning">仓管员</el-tag>
...
const openAdd = () => {
  ...
  form.value = { id: null, username: '', password: '', realName: '', phone: '', email: '', role: 'user' }
